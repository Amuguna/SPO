...
WANDB_PROJECT=spo-math APP_EXPERIMENT_NAME=llama3_1_8b-spo-tree-666 APP_DIRECTORY=SPO-experiments APP_MINIMIZE_STORED_FILES=True deepspeed --no_local_rank --num_gpus=$NUM_GPUS --master_port $MASTER_PORT src/treetune/main.py --configs "configs/llama3_1_8b_spo_chain_MATH.jsonnet" run_iteration_loop