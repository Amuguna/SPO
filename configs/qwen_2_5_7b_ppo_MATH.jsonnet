...
+ {
  episode_generator+: {
    ...
    inference_strategy: {
      ...
      guidance_llm: (import 'guidance_llms/qwen_2_5_7b.jsonnet') + { api_base: 'none' },
  ...
  trainer+: {
    ...
    actor_deepspeed_config: (import 'deepspeed/zero_1.jsonnet'),
    critic_deepspeed_config: (import 'deepspeed/zero_1.jsonnet'),
